...
export class ThreadComponent implements OnInit {
  ...
  getThread() {
    this.tweetService.getTweet(this.parentTweetId).subscribe(tweet => {this.parentTweet = tweet;}, () => {}, () => {
      ...
      if(this.parentTweet.content == (null || undefined) && this.parentTweet.parentId != (null || undefined)) {
        ...
        this.tweetService.getReplies(this.parentTweetId).subscribe(replies => {this.replies = replies},() => {}, () => {});

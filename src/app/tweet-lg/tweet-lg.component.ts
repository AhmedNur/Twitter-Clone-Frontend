...
export class TweetLgComponent implements OnInit {
  ...
  constructor(private tweetService: TweetService, private auth: AuthenticationService, private modalService: ModalService) {
  }
  ...
  setTweetTime() {
    ...
    this.tweet.timeSinceCreated = dateCreated.toLocaleTimeString('en-us', {
      hour: 'numeric',
      minute: 'numeric',
      hour12: true
    }) + " · " + TweetComponent.months[dateCreated.getMonth()] + dateCreated.getDate() + ", " + dateCreated.getFullYear();
  }
